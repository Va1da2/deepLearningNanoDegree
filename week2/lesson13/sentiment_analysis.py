...
net = tflearn.embedding(net, input_dim=10000, output_dim=128) # input dim is the number of words, 
														# output dim is the number of dimensions of our resulting embedings
